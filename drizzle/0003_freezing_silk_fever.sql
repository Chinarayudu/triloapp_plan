CREATE TABLE "chat_conversations" (
	...
	CONSTRAINT "chat_conversations_user_id_host_id_unique" UNIQUE("user_id","host_id")
);
...
ALTER TABLE "chat_conversations" ADD CONSTRAINT "chat_conversations_host_id_users_id_fk" FOREIGN KEY ("host_id") REFERENCES "public"."users"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
